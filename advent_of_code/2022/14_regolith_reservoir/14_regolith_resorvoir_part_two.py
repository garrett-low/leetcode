...
class rock_map:
    def __init__(self, rock_lines, min_row, max_row, min_col, max_col):
        ...
        # empty grid
        self.height = self.max_row + 3 # floor is 3 below lowest rock - inclusive of endpoint
        self.width = self.max_col - self.min_col + 3 + self.height * 2 # infinite floor
        ...
        for col in range(self.width):
            self.grid[self.height - 1][col] = rock
...
#         self.origin_y = 0
    ...
    def getx(self, x):
        return x - self.min_col + 1 + self.height
...
#         self.fall(new_sand)
        ...
        while done != None:
            ...
            if self.grid[sand_origin_y][sand_origin_x] == sand:
                break
