...
def camp_cleanup():
    ...
    with open('input.txt', 'rt', encoding='utf-8') as file:
        for line in file:
            ...
            if range_one_lower <= range_two_lower and range_one_upper >= range_two_upper:
                total_pairs += 1
            elif range_two_lower <= range_one_lower and range_two_upper >= range_one_upper:
                total_pairs += 1
